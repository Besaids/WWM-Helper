...
export const ITEMS_ASSETS: GameAssetDefinition[] = [
  ...
  {
    id: 'items.bamboocut_wind_tips',
    category: 'items',
    file: 'assets/game/items/item-bamboocut-wind-tips.png',
    label: 'Bamboocut Wind Tips',
    kind: 'material-icon',
    source: 'Where Winds Meet (in-game capture)',
    description: 'Martial Arts Tips item used for breakthroughs and progression.',
    game_system_tags: ['item', 'material', 'martial_arts', 'tips', 'planner'],
    ui_usage_notes: 'Use in planners and guides where this specific material is required.',
    width: 560,
    height: 480,
    aspect_ratio: '7:6',
  },
  {
    id: 'items.bellstrike_splendor_tips',
    category: 'items',
    file: 'assets/game/items/item-bellstrike-splendor-tips.png',
    label: 'Bellstrike Splendor Tips',
    kind: 'material-icon',
    source: 'Where Winds Meet (in-game capture)',
    description: 'Martial Arts Tips item used for breakthroughs and progression.',
    game_system_tags: ['item', 'material', 'martial_arts', 'tips', 'planner'],
  ...
  {
    id: 'items.bellstrike_umbra_tips',
    category: 'items',
    file: 'assets/game/items/item-bellstrike-umbra-tips.png',
    label: 'Bellstrike Umbra Tips',
    kind: 'material-icon',
    source: 'Where Winds Meet (in-game capture)',
    description: 'Martial Arts Tips item used for breakthroughs and progression.',
    game_system_tags: ['item', 'material', 'martial_arts', 'tips', 'planner'],
  ...
  {
    id: 'items.bluestone_lock',
    category: 'items',
    file: 'assets/game/items/item-bluestone-lock.png',
    label: 'Bluestone Lock',
    kind: 'material-icon',
    source: 'Where Winds Meet (in-game capture)',
    description: 'Upgrade material used in Martial Arts progression.',
    game_system_tags: ['item', 'material', 'martial_arts', 'planner'],
    ui_usage_notes: 'Use in planners and guides where this specific material is required.',
    width: 560,
    height: 480,
    aspect_ratio: '7:6',
  ...
  {
    id: 'items.bone_renewal_tonic',
    category: 'items',
    file: 'assets/game/items/item-bone-renewal-tonic.png',
    label: 'Bone Renewal Tonic',
    kind: 'material-icon',
    source: 'Where Winds Meet (in-game capture)',
    description: 'Upgrade material used in Martial Arts progression.',
    game_system_tags: ['item', 'material', 'martial_arts', 'planner'],
  ...
  },
  {
    id: 'items.coarse_fur',
    category: 'items',
    file: 'assets/game/items/item-coarse-fur.png',
    label: 'Coarse Fur',
    kind: 'material-icon',
    source: 'Where Winds Meet (in-game capture)',
    description: 'Enhancement material used in Gear Enhancement progression.',
    game_system_tags: ['item', 'material', 'gear_enhance', 'planner'],
    ui_usage_notes: 'Use in planners and guides where this specific material is required.',
    width: 560,
    height: 480,
    aspect_ratio: '7:6',
  },
  {
    id: 'items.cold_iron',
    category: 'items',
    file: 'assets/game/items/item-cold-iron.png',
    label: 'Cold Iron',
    kind: 'material-icon',
    source: 'Where Winds Meet (in-game capture)',
    description: 'Enhancement material used in Gear Enhancement progression.',
  ...
  {
    id: 'items.dushan_jade',
    category: 'items',
    file: 'assets/game/items/item-dushan-jade.png',
    label: 'Dushan Jade',
    kind: 'material-icon',
    source: 'Where Winds Meet (in-game capture)',
    description: 'Enhancement material used in Gear Enhancement progression.',
  ...
  {
    id: 'items.fat_tail_sheepskin',
    category: 'items',
    file: 'assets/game/items/item-fat-tail-sheepskin.png',
    label: 'Fat Tail Sheepskin',
    kind: 'material-icon',
    source: 'Where Winds Meet (in-game capture)',
    description: 'Enhancement material used in Gear Enhancement progression.',
    game_system_tags: ['item', 'material', 'gear_enhance', 'planner'],
  ...
  {
    id: 'items.pine_resin_ointment',
    category: 'items',
    file: 'assets/game/items/item-pine-resin-ointment.png',
    label: 'Pine Resin Ointment',
    kind: 'material-icon',
    source: 'Where Winds Meet (in-game capture)',
    description: 'Upgrade material used in Martial Arts progression.',
    game_system_tags: ['item', 'material', 'martial_arts', 'planner'],
  ...
  },
  {
    id: 'items.raw_ore',
    category: 'items',
    file: 'assets/game/items/item-raw-ore.png',
    label: 'Raw Ore',
    kind: 'material-icon',
    source: 'Where Winds Meet (in-game capture)',
    description: 'Enhancement material used in Gear Enhancement progression.',
  ...
  {
    id: 'items.scarlet_flame_ointment',
    category: 'items',
    file: 'assets/game/items/item-scarlet-flame-ointment.png',
    label: 'Scarlet Flame Ointment',
    kind: 'material-icon',
    source: 'Where Winds Meet (in-game capture)',
    description: 'Upgrade material used in Martial Arts progression.',
    game_system_tags: ['item', 'material', 'martial_arts', 'planner'],
  ...
  {
    id: 'items.silkbind_deluge_tips',
    category: 'items',
    file: 'assets/game/items/item-silkbind-deluge-tips.png',
    label: 'Silkbind Deluge Tips',
    kind: 'material-icon',
    source: 'Where Winds Meet (in-game capture)',
    description: 'Martial Arts Tips item used for breakthroughs and progression.',
    game_system_tags: ['item', 'material', 'martial_arts', 'tips', 'planner'],
  ...
  {
    id: 'items.silkbind_jade_tips',
    category: 'items',
    file: 'assets/game/items/item-silkbind-jade-tips.png',
    label: 'Silkbind Jade Tips',
    kind: 'material-icon',
    source: 'Where Winds Meet (in-game capture)',
    description: 'Martial Arts Tips item used for breakthroughs and progression.',
    game_system_tags: ['item', 'material', 'martial_arts', 'tips', 'planner'],
  ...
  {
    id: 'items.stonesplit_might_tips',
    category: 'items',
    file: 'assets/game/items/item-stonesplit-might-tips.png',
    label: 'Stonesplit Might Tips',
    kind: 'material-icon',
    source: 'Where Winds Meet (in-game capture)',
    description: 'Martial Arts Tips item used for breakthroughs and progression.',
    game_system_tags: ['item', 'material', 'martial_arts', 'tips', 'planner'],
  ...
  {
    id: 'items.tiger_bone_liquor',
    category: 'items',
    file: 'assets/game/items/item-tiger-bone-liquor.png',
    label: 'Tiger Bone Liquor',
    kind: 'material-icon',
    source: 'Where Winds Meet (in-game capture)',
    description: 'Upgrade material used in Martial Arts progression.',
    game_system_tags: ['item', 'material', 'martial_arts', 'planner'],
  ...
  {
    id: 'items.wolframite_weight',
    category: 'items',
    file: 'assets/game/items/item-wolframite-weight.png',
    label: 'Wolframite Weight',
    kind: 'material-icon',
    source: 'Where Winds Meet (in-game capture)',
    description: 'Upgrade material used in Martial Arts progression.',
    game_system_tags: ['item', 'material', 'martial_arts', 'planner'],
  ...
  },
  {
    id: 'items.bear_pelt',
    category: 'items',
    file: 'assets/game/items/item-bear-pelt.png',
    label: 'Bear Pelt',
    kind: 'development-material-icon',
    source: 'Where Winds Meet (in-game capture)',
    description: 'Enhancement material used in Gear Enhancement progression.',
    ...
    ui_usage_notes:
      'Use in the Gear Enhancement Upgrade Planner and any gear progression tables that reference Bear Pelt as a breakthrough requirement.',
    width: 560,
    height: 480,
    aspect_ratio: '7:6',
  },
  {
    id: 'items.lethal_crystal',
    category: 'items',
    file: 'assets/game/items/item-lethal-crystal.png',
    label: 'Lethal Crystal',
    kind: 'development-material-icon',
    source: 'Where Winds Meet (in-game capture)',
    description: 'Enhancement material used in Gear Enhancement progression.',
    game_system_tags: [
    ...
    ui_usage_notes:
      'Use in the Gear Enhancement Upgrade Planner and any gear progression tables that reference Lethal Crystal as a breakthrough requirement.',
    width: 560,
    height: 480,
    aspect_ratio: '7:6',
  },
  {
    id: 'items.aromatic_jade',
    category: 'items',
    file: 'assets/game/items/item-aromatic-jade.png',
    label: 'Aromatic Jade',
    kind: 'development-material-icon',
    source: 'Where Winds Meet (in-game capture)',
    description: 'Enhancement material used in Gear Enhancement progression.',
    ...
    ui_usage_notes:
      'Use in the Gear Enhancement Upgrade Planner and any gear progression tables that reference Aromatic Jade as a breakthrough requirement.',
    width: 560,
    height: 480,
    aspect_ratio: '7:6',
  },
