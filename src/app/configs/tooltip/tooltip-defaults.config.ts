...
const ASSET_TOOLTIP_BINDINGS: Record<string, string> = {
  ...
  'items.activity_appearance_ticket': 'items.activity_appearance_ticket',
  'items.activity_appearance_ticket_description': 'items.activity_appearance_ticket_description',
  'items.bounty_token': 'items.bounty_token',
  'items.bounty_token_description': 'items.bounty_token_description',
  'items.career_notebook': 'items.career_notebook',
  'items.career_notebook_description': 'items.career_notebook_description',
  'items.garment_design_shard': 'items.garment_design_shard',
  'items.garment_design_shard_description': 'items.garment_design_shard_description',
  'items.cosmetic_chest': 'items.cosmetic_chest',
  'items.outpost_cosmetic_chest': 'items.outpost_cosmetic_chest',
  'items.outpost_cosmetic_chest_description': 'items.outpost_cosmetic_chest_description',
  'items.oscillating_jade': 'items.oscillating_jade',
  'items.oscillating_jade_description': 'items.oscillating_jade_description',
  'items.gear_chest': 'items.gear_chest',
  'items.inner_way_note_chest': 'items.inner_way_note_chest',
  'items.martial_arts_chest': 'items.martial_arts_chest',
  'items.support_box': 'items.support_box',
  'items.small_bag': 'items.small_bag',
  'items.small_box': 'items.small_box',
  'items.string_of_coins': 'items.string_of_coins',
  'items.string_of_coins_description': 'items.string_of_coins_description',
  'items.healer_giftbox_description': 'items.healer_giftbox_description',
  'items.scholar_giftbox_description': 'items.scholar_giftbox_description',
  'items.custom_career_giftbox_description': 'items.custom_career_giftbox_description',
  'items.martial_arts_chest_description': 'items.martial_arts_chest_description',
  'items.custom_martial_arts_breakthrough_chest_description':
    'items.custom_martial_arts_breakthrough_chest_description',
  'items.mystic_skills_breakthrough_support_box_description':
    'items.mystic_skills_breakthrough_support_box_description',
  'items.life_supplies_support_box_description': 'items.life_supplies_support_box_description',
  'items.small_box_of_commerce_coins_description': 'items.small_box_of_commerce_coins_description',
  'items.inner_way_note_chest_description': 'items.inner_way_note_chest_description',
  'items.inner_way_note_custom_chest_description': 'items.inner_way_note_custom_chest_description',
  'items.tier_56_path_chest_description': 'items.tier_56_path_chest_description',

  // Items (Martial Arts / Gear Enhancement materials)
  'items.bamboocut_wind_tips': 'items.bamboocut_wind_tips',
  'items.bellstrike_splendor_tips': 'items.bellstrike_splendor_tips',
  'items.bellstrike_umbra_tips': 'items.bellstrike_umbra_tips',
  'items.bluestone_lock': 'items.bluestone_lock',
  'items.bone_renewal_tonic': 'items.bone_renewal_tonic',
  'items.coarse_fur': 'items.coarse_fur',
  'items.cold_iron': 'items.cold_iron',
  'items.dushan_jade': 'items.dushan_jade',
  'items.fat_tail_sheepskin': 'items.fat_tail_sheepskin',
  'items.pine_resin_ointment': 'items.pine_resin_ointment',
  'items.raw_ore': 'items.raw_ore',
  'items.scarlet_flame_ointment': 'items.scarlet_flame_ointment',
  'items.silkbind_deluge_tips': 'items.silkbind_deluge_tips',
  'items.silkbind_jade_tips': 'items.silkbind_jade_tips',
  ...
  'martial_arts.infernal_twinblades': 'martial_arts.infernal_twinblades',
  'martial_arts.inkwell_fan': 'martial_arts.inkwell_fan',
  'martial_arts.mortal_rope_dart': 'martial_arts.mortal_rope_dart',
  'martial_arts.nameless_spear': 'martial_arts.nameless_spear',
  'martial_arts.nameless_sword': 'martial_arts.nameless_sword',
  'martial_arts.panacea_fan': 'martial_arts.panacea_fan',
  'martial_arts.soulshade_umbrella': 'martial_arts.soulshade_umbrella',
  'martial_arts.stormbreaker_spear': 'martial_arts.stormbreaker_spear',
  'martial_arts.strategic_sword': 'martial_arts.strategic_sword',
  'martial_arts.thundercry_blade': 'martial_arts.thundercry_blade',
  'martial_arts.vernal_umbrella': 'martial_arts.vernal_umbrella',

  // Gear Enhancement
  'gear_enhance.armor': 'gear_enhance.armor',
  'gear_enhance.bracer': 'gear_enhance.bracer',
  'gear_enhance.disc': 'gear_enhance.disc',
  'gear_enhance.greaves': 'gear_enhance.greaves',
  'gear_enhance.helm': 'gear_enhance.helm',
  'gear_enhance.left_hand_weapon': 'gear_enhance.left_hand_weapon',
  'gear_enhance.pendant': 'gear_enhance.pendant',
  'gear_enhance.right_hand_weapon': 'gear_enhance.right_hand_weapon',
