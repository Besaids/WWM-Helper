...
export const MULTI_DAY_ACTIVITIES: MultiDayActivity[] = [
  ...
  },
  {
    ...
    rewardSummary: '+1 Constitution per day (up to +10 total) + co-op rewards.',
    location: "Qinghe – West Heaven's Pier (Well of Heaven Special Training)",
    daysRequired: '10 days',
    perDayLimit: '+1 Constitution per completion',
    consecutive: false,
    checklistId: 'daily-well-of-heaven-training',
    checklistLabel: 'Well of Heaven Special Training (+1 Constitution).',
    steps: [
      {
        id: 'woh-wandering-paths',
        title: '1. Open Wandering Paths',
        body: 'Press the appropriate key/button to open the Wandering Paths menu (your co-op activity menu). Select "Casual Co-op" from the available options.',
        image: `${ASSETS_BASE}/well-of-heaven-special-training-wandering-paths.png`,
        alt: 'Wandering Paths menu with Casual Co-op highlighted',
        caption: 'Open Wandering Paths and select "Casual Co-op".',
      },
      {
        id: 'woh-coop-select',
        title: '2. Select Well of Heaven Special Training',
        body: 'In the Casual Co-op → Adventure section, find "Well of Heaven Special Training" and click "Participate" to queue.',
        image: `${ASSETS_BASE}/well-of-heaven-special-training-casual-coop-adventure.png`,
        alt: 'Casual Co-op screen with Well of Heaven Special Training selected',
        caption: 'Select the activity and press Participate.',
      },
      {
        id: 'woh-spawn',
        title: '3. Spawn location',
        body: "After teleporting to West Heaven's Pier, you'll spawn at this location. Look for other players gathering.",
        image: `${ASSETS_BASE}/well-of-heaven-special-training-spawned-path.png`,
        alt: "The spawn point at West Heaven's Pier",
        caption: 'Where you spawn after teleporting in.',
      },
      {
        id: 'woh-merge',
        title: '4. Merge into the running line',
        body: 'Players form a "conga line" and run laps together. Find the running group and interact to merge into the line.',
        image: `${ASSETS_BASE}/well-of-heaven-special-training-merge-into-line.png`,
        alt: 'Players in a conga line formation',
        caption: 'Interact to merge into the running line.',
      },
      {
        id: 'woh-objectives',
        title: '5. Complete objectives',
        body: 'While running, you\'ll need to complete 2 training laps and hit the "Respond to Slogan" QTE 4 times. Watch the HUD on the left for your progress and be ready to react when the QTE prompt appears.',
        image: `${ASSETS_BASE}/well-of-heaven-special-training-objectives.png`,
        alt: 'HUD showing objectives and the Respond to Slogan QTE prompt',
        caption: 'Complete 2 laps and respond to 4 slogan prompts.',
      },
      {
        id: 'woh-extra-info',
        title: '6. Extra information',
        body: 'You can view additional event details and information from this panel.',
        image: `${ASSETS_BASE}/well-of-heaven-special-training-extra-info.png`,
        alt: 'Extra information panel about the event',
        caption: 'Extra event details.',
      },
      {
        id: 'woh-completion',
        title: '7. Completion rewards',
        body: "After finishing, you'll see a completion screen showing the Constitution you gained. You can earn +1 Constitution per day, up to +10 total. Days do not need to be consecutive!",
        image: `${ASSETS_BASE}/well-of-heaven-special-training-completion.png`,
        alt: 'Completion screen showing Constitution gained',
        caption: '+1 Constitution gained – repeat daily up to 10 times for +10 total.',
      },
    ],
  },
];
