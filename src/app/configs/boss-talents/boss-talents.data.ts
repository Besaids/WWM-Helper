...
const TWIN_LIONS_TRACKS: BossTalentTrack[] = [
  {
    ...
    tiers: [
      ...
      mkTier(
        ...
        null,
        undefined,
        'TODO – Tier 2 requirement / unlock from in-game Twin Lions offensive node.',
      ),
      mkTier(
        3,
        null,
        ...
        null,
        undefined,
        'TODO – Tier 3 requirement / unlock from in-game Twin Lions offensive node.',
      ),
    ],
  },
  {
    ...
    tiers: [
      ...
      mkTier(
        ...
        null,
        undefined,
        'TODO – Tier 2 requirement / unlock from in-game Twin Lions defensive node.',
      ),
      mkTier(
        3,
        null,
        ...
        null,
        undefined,
        'TODO – Tier 3 requirement / unlock from in-game Twin Lions defensive node.',
      ),
    ],
  },
  {
    ...
    tiers: [
      ...
      mkTier(
        ...
        null,
        undefined,
        'TODO – Tier 2 requirement / unlock (likely additional clears of Blazing Gale Dance).',
      ),
    ],
  },
];
