...
const GHOST_MASTER_TRACKS: BossTalentTrack[] = [
  {
    ...
    tiers: [
      ...
      mkTier(
        2,
        "Defeat Ghost Master in Hero's Realm without getting hit by 'Vanished Trail' and 'Soul Abyss,' and destroy all Paper Puppets carrying the sedan within 10 seconds.",
        'DMG +20% vs Ghost Master in Exhausted State',
        71,
      ),
      mkTier(
        3,
        "Defeat Ghost Master in Sorrow of Mortalbound in a team. Make sure Ghost Master returns to the sedan for no more than 15 seconds after casting 'Eternal Extinction' and 'Phantom\\'s Return.'",
  ...
  },
  {
    ...
    tiers: [
      ...
      mkTier(
        2,
        "Defeat Ghost Master in Hero's Realm and get hit by 'Flower Path' less than 5 times while transformed into Golden Shackle and Silver Chain, or when affected by 'Into the Sedan.'",
        "DMG and Healing +10% vs Ghost Master's sedan",
        71,
      ),
      mkTier(
        3,
        "Defeat Ghost Master in Sorrow of Mortalbound in a team and make sure when a player is sent 'Into the Sedan,' no other teammate is hit by 'Flower Path.'",
